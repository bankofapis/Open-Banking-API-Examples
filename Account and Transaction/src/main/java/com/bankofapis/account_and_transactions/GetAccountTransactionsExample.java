...
public class GetAccountTransactionsExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String accountTransactions = getAccountTransactionsUsingToken(authToken, accountId);
        GetAccountTransactionsDTO getAccountTransactionsDTO = generateAccountTransactionsDTOFromResponse(accountTransactions);
        System.out.println(getAccountTransactionsDTO);
    }

    public static GetAccountTransactionsDTO generateAccountTransactionsDTOFromResponse(String accountTransactions) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(accountTransactions, GetAccountTransactionsDTO.class);
    }

    private static String getAccountTransactionsUsingToken(OAuthResponseDTO accountAccessToken, String accountId) throws Exception {
        ...
        HttpResponse response = client.get("/open-banking/v3.1/aisp/accounts/" + accountId + "/transactions", headers);
