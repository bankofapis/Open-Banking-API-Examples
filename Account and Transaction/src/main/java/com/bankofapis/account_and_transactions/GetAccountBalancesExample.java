...
public class GetAccountBalancesExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String balancesResponse = getAccountBalancesUsingToken(accountAccessToken, accountId);
        GetAccountBalancesDTO accountBalancesData = createResponseDTO(balancesResponse);
        System.out.println(accountBalancesData);
    }

    public static GetAccountBalancesDTO createResponseDTO(String responseString) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(responseString, GetAccountBalancesDTO.class);
    }

    private static String getAccountBalancesUsingToken(String accountAccessToken, String accountId) throws Exception {
        ...
        HttpResponse response = client.get("/open-banking/v3.1/aisp/accounts/" + accountId + "/balances", headers);
